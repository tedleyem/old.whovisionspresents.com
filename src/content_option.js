...
const meta = {
    title: "Whovisions",
    description: "Whovisions is a Professional Video, Photography, Tech Support & Delivery Service provider.",
};

const introdata = {
    title: "We are Whovisions",
    animated: {
        first: "We capture memories",
        second: "We capture beauty",
